...
Public Class DailyReport___Copy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccountingSystem.DailyReport - Copy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyReport___Copy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyReport___Copy = New DailyReport___Copy()
        rpt.Site = Me.Site
        Return rpt
    End Function
