...
Public Class DailySales
    ...
    Private Sub addButton_Click(sender As Object, e As EventArgs) Handles addButton.Click
        If salesRadio.Checked = True Then
        ...
        End If
    End Sub
    Private Sub remitRadio_CheckedChanged(sender As Object, e As EventArgs) Handles remitRadio.CheckedChanged
        If remitRadio.Checked Then
            ' Uncheck the other radio button
            salesRadio.Checked = False

            ' Show the Remittance form
            Remittance.Show()
        End If
    End Sub
